package com.lcw.msgspringboot13cache.utils;
...
public class RedisClient {
    ...
    /**
     * hash递增 如果不存在 就创建一个新的 并把新增后的值返回
     *
     * @param key  键
     * @param item 项
     * @param by   要增加几（大于几）
     ...
     * @param key   键
     * @param index 索引
     * @return index 索引   index>=0,0代表开头,1代表第二个元素，以此类推；inde<0时，-1表尾，-2倒数第2个元素，以此类推
     */
